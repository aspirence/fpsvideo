...
export const metadata: Metadata = {
  title: "About — FPS",
  description:
    "Learn about FPS — a media production house crafting stories that engage audiences and deliver results."
};
  ...
  return (
    <>
      <PageHeader
        ...
        subtitle="Trusted by creators and brands across India. Crafting content that travels — from the first idea to the final frame."
