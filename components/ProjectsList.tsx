          ...
          <Reveal key={p.id}>
            ...
            >
              ...
              >
                ...
                <span className="absolute left-4 top-4 border border-white/15 bg-black/80 px-3 py-1.5 text-[10px] font-semibold uppercase tracking-[0.25em] text-white shadow-lg backdrop-blur">
                  {p.category}
                </span>
              </Link>
              ...
              <div className={mediaLeft ? "lg:order-2" : "lg:order-1"}>
                ...
                <Link
                  href={`/projects/${p.slug}`}
                  className="mt-8 inline-flex items-center gap-2 text-sm font-semibold text-white transition hover:text-white"
                >
